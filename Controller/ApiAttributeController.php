...
final class ApiAttributeController extends Controller
{
     ...
     * @since 1.0.0
     */
    public function apiItemAttributeDelete(RequestAbstract $request, ResponseAbstract $response, mixed $data = null) : void
    {
     ...
     * @since 1.0.0
     */
    public function apiItemAttributeTypeL11nUpdate(RequestAbstract $request, ResponseAbstract $response, mixed $data = null) : void
    {
     ...
     * @since 1.0.0
     */
    public function apiItemAttributeTypeL11nDelete(RequestAbstract $request, ResponseAbstract $response, mixed $data = null) : void
    {
     ...
     * @since 1.0.0
     */
    public function apiItemAttributeTypeUpdate(RequestAbstract $request, ResponseAbstract $response, mixed $data = null) : void
    {
     ...
     * @since 1.0.0
     */
    public function apiItemAttributeTypeDelete(RequestAbstract $request, ResponseAbstract $response, mixed $data = null) : void
    {
     ...
     * @since 1.0.0
     */
    public function apiItemAttributeValueUpdate(RequestAbstract $request, ResponseAbstract $response, mixed $data = null) : void
    {
     ...
     * @since 1.0.0
     */
    public function apiItemAttributeValueL11nUpdate(RequestAbstract $request, ResponseAbstract $response, mixed $data = null) : void
    {
     ...
     * @since 1.0.0
     */
    public function apiItemAttributeValueL11nDelete(RequestAbstract $request, ResponseAbstract $response, mixed $data = null) : void
    {
